...
3. **左上下文注意力计算**
   ...
   1. 提取键向量和值向量：
      ...
      - 键向量：$k\_{1}^{l},\ldots,k\_{n\_{f}^{l}}^{l}\in R^{d\_{k}^{l}}$
      - 值向量：$v\_{1}^{l},\ldots,v\_{n\_{f}^{l}}^{l}\in R^{d\_{v}^{l}}$

   2. 计算注意力分数：

   $$
   e\_{i}^{l}=\operatorname{score}\left(r^{t}, k\_{i}^{l}\right)
   $$
   ...
   $$
   r^{l}=\sum\_{i=1}^{n\_{f}^{l}} a\_{i}^{l}v\_{i}^{l}
   $$
...
4. **右上下文注意力计算**
   ...
   1. 提取键向量和值向量：
      ...
      - 键向量：$k\_{1}^{r},\ldots,k\_{n\_{f}^{r}}^{r}\in R^{d\_{k}^{r}}$
      - 值向量：$v\_{1}^{r},\ldots,v\_{n\_{f}^{r}}^{r}\in R^{d\_{v}^{r}}$

   2. 计算注意力分数：

   $$
   e\_{i}^{r}=\operatorname{score}\left(r^{t}, k\_{i}^{r}\right)
   $$
   ...
   $$
   r^{r}=\sum\_{i=1}^{n\_{f}^{r}} a\_{i}^{r}v\_{i}^{r}
   $$
...
5. **目标短语更新表示**
   ...
   1. 提取目标短语的键向量和值向量：
      ...
      - 键向量：$k\_{1}^{t},\ldots,k\_{n\_{f}^{t}}^{t}\in R^{d\_{k}^{t}}$
      - 值向量：$v\_{1}^{t},\ldots,v\_{n\_{f}^{t}}^{t}\in R^{d\_{v}^{t}}$
...
$$
r=\operatorname{concat}\left(r^{l},r^{r},r^{l\_{t}},r^{r\_{t}}\right)
$$
